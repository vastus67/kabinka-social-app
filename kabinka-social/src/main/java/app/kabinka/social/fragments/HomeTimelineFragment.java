...
import app.kabinka.social.BuildConfig;
import app.kabinka.social.E;
import app.kabinka.social.R;
import app.kabinka.social.api.MastodonAPIRequest;
import app.kabinka.social.api.requests.catalog.GetDonationCampaigns;
import app.kabinka.social.api.requests.markers.SaveMarkers;
import app.kabinka.social.api.requests.timelines.GetHomeTimeline;
import app.kabinka.social.api.requests.timelines.GetListTimeline;
import app.kabinka.social.api.requests.timelines.GetPublicTimeline;
import app.kabinka.social.api.session.AccountSessionManager;
import app.kabinka.social.events.DismissDonationCampaignBannerEvent;
import app.kabinka.social.events.SelfUpdateStateChangedEvent;
import app.kabinka.social.fragments.settings.SettingsMainFragment;
import app.kabinka.social.model.CacheablePaginatedResponse;
...
import app.kabinka.social.model.donations.DonationCampaign;
...
import app.kabinka.social.ui.sheets.DonationSheet;
import app.kabinka.social.ui.sheets.DonationSuccessfulSheet;
import app.kabinka.social.ui.utils.DiscoverInfoBannerHelper;
import app.kabinka.social.ui.utils.UiUtils;
import app.kabinka.social.ui.viewcontrollers.HomeTimelineMenuController;
import app.kabinka.social.ui.viewcontrollers.ToolbarDropdownMenuController;
import app.kabinka.social.ui.views.FixedAspectRatioImageView;
import app.kabinka.social.ui.views.NestedRecyclerScrollView;
import app.kabinka.social.ui.views.NewPostsButtonContainer;
import app.kabinka.social.updater.GithubSelfUpdater;
import org.parceler.Parcels;
import app.kabinka.social.fluffychat.FluffyChatLauncher;
...
public class HomeTimelineFragment extends StatusListFragment implements ToolbarDropdownMenuController.HostFragment{
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater){
		...
		// Show chat button only on home page timeline (not on lists)
		menu.findItem(R.id.chat).setVisible(listMode!=ListMode.LIST);
	...
	/**
	 * Open FluffyChat activity
	 */
	private void openFluffyChat() {
		FluffyChatLauncher.INSTANCE.launchDirectly(getActivity());
	}
