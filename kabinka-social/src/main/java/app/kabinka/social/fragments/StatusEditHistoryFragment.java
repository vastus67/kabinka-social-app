...
import app.kabinka.social.api.requests.statuses.GetStatusEditHistory;
...
public class StatusEditHistoryFragment extends StatusListFragment{
	...
	protected List<StatusDisplayItem> buildDisplayItems(Status s){
		...
		if(idx>=0){
			...
			items.add(0, new ReblogOrReplyLineStatusDisplayItem(s.id, this, getActivity(), action+" Â· "+date, null, 0, accountID));
		}
		return items;
	}
