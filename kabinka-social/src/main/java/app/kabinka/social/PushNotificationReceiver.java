...
import app.kabinka.social.api.requests.notifications.GetNotificationByID;
...
import app.kabinka.social.model.PushNotification;
...
public class PushNotificationReceiver extends BroadcastReceiver{
					...
					try{
						...
						new GetNotificationByID(pn.notificationId)
								.setCallback(new Callback<>(){
									@Override
									public void onSuccess(app.kabinka.social.model.Notification result){
	...
	private void notify(Context context, PushNotification pn, String accountID, app.kabinka.social.model.Notification notification){
	...
	private void doNotify(Context context, PushNotification pn, String accountID, app.kabinka.social.model.Notification notification, Drawable avatar){
